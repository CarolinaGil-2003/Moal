...
<?php
function Redirect($message, $message_type = "danger", $location = 'index.php')
{
        ...
        if (isset($_SESSION['user_mail'])) {
            ...
            if ($result) {
                if (is_null($user)) {
                    ...
                    if ($result) {
                        Redirect('Hemos sido informados de tu compra, dentro de poco te llegará el pedido!', 'success', 'productos.php');
                    } else {
